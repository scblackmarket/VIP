...
### INSTALL SCRIPT
```
wget -q https://raw.githubusercontent.com/scblackmatket/vip/main/setup.sh && chmod +x setup.sh && ./setup.sh
```
### UPDATE SCRIPT
```
wget -q https://raw.githubusercontent.com/scblackmatket/vip/main/menu/update.sh && chmod +x update.sh && ./update.sh
```
